...
const { newProductList, getStoreProducts, getStoreProductsById, manageProducts, getStrProductsbyCategoryId, postProductEntrilist } = require("../../../controllers/it/product");
