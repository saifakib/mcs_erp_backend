...
const selectMaintanances = (hrid) => {
    if(hrid) {
        return ExecuteIT(`  SELECT M.MAINTENANCE_ID, M.IND_PRO_ID, M.IND_PRO_REQ_ID, TO_CHAR(M.REQ_DATE, 'MON DD, YYYY') AS REQUEST_DATE, C.CATEGORY_NAME, 
...
module.exports = {
    selectMaintanances, insertMaintananceReq, insertServicing, updateMaintanance, updateServicing
}