...
const selectUserAcceptRequisitions = (user_id) =>
  ExecuteIT(`SELECT I.IND_PRO_ID AS IND_PRO_REQ_ID, I.STR_PRO_ID, R.HR_ID, IP.IND_PRODUCT_ID, PL.PRODUCT_NAME, IP.UNIQUE_V, B.BRAND_NAME, M.MODEL_NAME, C.CATEGORY_NAME FROM IND_PRO_REQUISITION I 
  ...
  LEFT OUTER JOIN CATEGORIES C ON C.CATEGORY_ID = PL.PRODUCT_ID
