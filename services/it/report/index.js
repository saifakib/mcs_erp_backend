...
const selectIndividualProdRequisitions = (ind_prod_id) => ExecuteIT(`SELECT IPR.PRO_REQ_ID, PR.REQ_ID, TO_CHAR(R.REQ_DATE,'DD-MM-YYYY') AS REQ_DATE, TO_CHAR(IPR.RETURN_DATE,'DD-MM-YYYY') AS RETURN_DATE, VE.*  FROM IND_PRO_REQUISITION IPR 
