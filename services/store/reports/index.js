...
const getProductSummariesByProductid = (PROID) => Execute(`SELECT PS.SUMMDATE, PS.PRODUCTNAME, PS.INTIALQTY, PS.NEWADDQTY, PS.TOTALBALANCE, PS.TOTALOUT, PS.PRESENTBALANCE, P.NAME_ENGLISH AS NAME, PG.DESIGNATION, PD.DEPARTEMENT AS DEPARTMENT, C.CATEGORYBN, C.CATEGORYEN FROM STR_PRODUCTSUMMARIES PS LEFT OUTER JOIN hrm.EMPLOYEE P ON PS.REQUISITIONFOR = P.EMPLOYE_ID LEFT OUTER JOIN STR_CATEGORIES C ON PS.PROCAT = C.CAT_ID LEFT OUTER JOIN hrm.DESIGNATION PG ON P.DESIGNATION_ID = PG.DESIGNATION_ID LEFT OUTER JOIN hrm.DEPARTMENT_LIST PD ON P.DEPARTEMENT_ID = PD.DEPARTEMENT_ID WHERE PS.PRODUCTID = ${PROID} ORDER BY PROSUMID ASC`);


const getProductSummariesBySummMonth = (SUMMMONTH) => Execute(`SELECT PS.SUMMDATE, PS.PRODUCTNAME, PS.INTIALQTY, PS.NEWADDQTY, PS.TOTALBALANCE, PS.TOTALOUT, PS.PRESENTBALANCE, P.NAME_ENGLISH AS NAME, PG.DESIGNATION, PD.DEPARTEMENT AS DEPARTMENT, C.CATEGORYBN, C.CATEGORYEN , C.CATEGORYBN, C.CATEGORYEN FROM STR_PRODUCTSUMMARIES PS LEFT OUTER JOIN hrm.EMPLOYEE P ON PS.REQUISITIONFOR = P.EMPLOYE_ID LEFT OUTER JOIN hrm.DESIGNATION PG ON P.DESIGNATION_ID = PG.DESIGNATION_ID LEFT OUTER JOIN hrm.DEPARTMENT_LIST PD ON P.DEPARTEMENT_ID = PD.DEPARTEMENT_ID LEFT OUTER JOIN STR_CATEGORIES C ON PS.PROCAT = C.CAT_ID  WHERE PS.SUMMMONTH = ${SUMMMONTH} ORDER BY PROSUMID ASC`);


const getProductSummariesBySummMonthAndCatId = (SUMMMONTH, CATID) => Execute(`SELECT PS.SUMMDATE, PS.PRODUCTNAME, PS.INTIALQTY, PS.NEWADDQTY, PS.TOTALBALANCE, PS.TOTALOUT, PS.PRESENTBALANCE, P.NAME_ENGLISH AS NAME, PG.DESIGNATION, PD.DEPARTEMENT AS DEPARTMENT, C.CATEGORYBN, C.CATEGORYEN FROM STR_PRODUCTSUMMARIES PS LEFT OUTER JOIN hrm.EMPLOYEE P ON PS.REQUISITIONFOR = P.EMPLOYE_ID LEFT OUTER JOIN hrm.DESIGNATION PG ON P.DESIGNATION_ID = PG.DESIGNATION_ID LEFT OUTER JOIN hrm.DEPARTMENT_LIST PD ON P.DEPARTEMENT_ID = PD.DEPARTEMENT_ID LEFT OUTER JOIN STR_CATEGORIES C ON PS.PROCAT = C.CAT_ID  WHERE PS.SUMMMONTH = ${SUMMMONTH} AND PS.PROCAT = ${Number(CATID)} ORDER BY PROSUMID ASC`);

const getProductSummariesByCatId = (CATID) => Execute(`SELECT PS.SUMMDATE, PS.PRODUCTNAME, PS.INTIALQTY, PS.NEWADDQTY, PS.TOTALBALANCE, PS.TOTALOUT, PS.PRESENTBALANCE, P.NAME_ENGLISH AS NAME, PG.DESIGNATION, PD.DEPARTEMENT AS DEPARTMENT, C.CATEGORYBN, C.CATEGORYEN FROM STR_PRODUCTSUMMARIES PS LEFT OUTER JOIN hrm.EMPLOYEE P ON PS.REQUISITIONFOR = P.EMPLOYE_ID LEFT OUTER JOIN hrm.DESIGNATION PG ON P.DESIGNATION_ID = PG.DESIGNATION_ID LEFT OUTER JOIN hrm.DEPARTMENT_LIST PD ON P.DEPARTEMENT_ID = PD.DEPARTEMENT_ID LEFT OUTER JOIN STR_CATEGORIES C ON PS.PROCAT = C.CAT_ID  WHERE PS.PROCAT = ${Number(CATID)} ORDER BY PROSUMID ASC`);
