...
module.exports.postProRequisition = (array) => {
  ...
  const statement = `INSERT INTO STR_PROREQUISITIONS (HRIDNO, REQUIBY, REQUIID, PROID, PROREQUQTY, PREMARKS, APROQTY, REQUPRODSTATUS, PRODATE, PROMONTH) VALUES (:HRIDNO, :REQUIBY, :REQUIID, :PROID, :PROREQUQTY, :PREMARKS, :APROQTY, :REQUPRODSTATUS, :PRODATE, :PROMONTH)`;
