...
const getExStoreProductByProdListId = (PROID) =>
  Execute(
    `SELECT PROID, PRONAME, PRONAMETWO, PROCATE, PRODUNIT, PROQTY, STOCKALERT, UNIT, PROTSTATUS, PRODLISTID AS PROD_LIST_ID from STR_STOREPRODUCTS S left outer join STR_UNITS U on S.PRODUNIT = U.UNIT_ID where proid = ${PROID}`
  );
